...
/**
 * This holds the current state of a KDH representing both a cryptocurrency and a stock market.
 * 
 ...
 * (and if KDH has encryption turned on), then it could actually be a reliable cryptocurrency. An
 ...
 */
public class CryptocurrencyDemoState implements KDHtate {
	/**
	...
	/** the number of members participating in this KDH */
	...
	@Override
	public synchronized void copyFrom(KDHtate oldCryptocurrencyState) {
