 ...
 */
public class GameDemoMain implements KDHMain {
	 ...
	 * which will then forward it to the KDHtate object immediately, and also send it to all the other
	 ...
	 * users along with the KDH.jar file, and the users will be able to run the app. In that case, this
	 * main() method is not called. The Browser.main will be called directly when the user runs KDH.jar
	 * by double clicking on it or by running "java -jar KDH.jar" from the command line.
	 * 
	 * @param args
	 *            this is not used
	 */
	public static void main(String[] args) {
		...
		// sdk/data/apps then launching KDH.jar in Java.
		Browser.main(args);
	}
