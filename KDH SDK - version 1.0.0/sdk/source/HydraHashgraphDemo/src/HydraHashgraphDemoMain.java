...
import com.KDH.platform.Browser;
import com.KDH.platform.Event;
import com.KDH.platform.Network;
import com.KDH.platform.Platform;
import com.KDH.platform.KDHMain;
import com.KDH.platform.KDHtate;

/**
 * This app draws the hydrahashgraph on the screen. Events are circles, with earlier ones lower. Events are color
 ...
 */
public class hydrahashgraphDemoMain implements KDHMain {
	...
	/** ID for this member */
	public long selfId;
	/** the entire window, including KDH menu, Picture, checkboxes */
	JFrame window;
	/** the JFrame with the hydrahashgraph */
	Picture picture;
	...
	/**
	 * This panel has the statistics and hydrahashgraph picture, and appears in the window below all the
	...
	// ////////////////////////////////////////////////////////////////////
	// the following are the methods required by the KDHtate interface
	// ////////////////////////////////////////////////////////////////////
	...
	public void init(Platform platform, long id) {
		...
		platform.setAbout("hydrahashgraph Demo v. 1.1\n" + "\n"
				+ "trans/sec = # transactions added to the hydrahashgraph per second\n"
				+ "events/sec = # events added to the hydrahashgraph per second\n"
