...
public class HelloKDHDemoMain implements KDHMain {
	...
	public void init(Platform platform, long id) {
		...
		platform.setAbout("Hello KDH v. 1.0\n"); // set the browser's "about" box
	...
	public void run() {
		...
		console.out.println("Hello KDH from " + myName);
		...
		while (true) {
			HelloKDHDemoState state = (HelloKDHDemoState) platform
					.getState();
